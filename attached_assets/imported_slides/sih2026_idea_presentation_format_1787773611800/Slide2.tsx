      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"IDEA TITLE"}</span></p></div><div key={2} style={{
        position: "absolute",
        left: "0px",
        top: "216.79px",
        width: "1280px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#1f497d"
          }}>{"Proposed Solution (Describe your Idea/Solution/Prototype)"}</span></p><p style={{
          lineHeight: "1.2",
          textIndent: "-36px",
          paddingLeft: "36px",
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(28pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"Detailed explanation of the proposed solution"}</span></p><p style={{
          textAlign: "justify",
          lineHeight: "1.2",
          textIndent: "-36px",
          paddingLeft: "36px",
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(28pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{" How it addresses the problem"}</span></p><p style={{
          textAlign: "justify",
          lineHeight: "1.2",
          textIndent: "-36px",
          paddingLeft: "36px",
          ...
          marginBottom: "0"
            ...
            fontSize: "calc(28pt * var(--pptx-font-scale, 1))",
            fontFamily: "Arial, 'Helvetica Neue', sans-serif"
          }}>{"Innovation and uniqueness of the solution "}</span></p></div><div key={3} style={{
        position: "absolute",
        left: "488px",
        top: "667.33px",
        width: "336.38px",
